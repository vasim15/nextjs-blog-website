...
import { IArticle, ICollectionResponse, IQueryType } from '@/types';
import { formatDate, serializMarkDown } from '@/utils';
...
const Article = ({ article, notFound }: IPropType) => {
    ...
    return (<>
        <Head>
            <title>Create Next App | {article.attributes.title}</title>
        ...
        <div className='my-12 grid lg:grid-cols-3 gap-12 single-article'>
            <div className='col-span-2'>
                ...
                <div className='text-lg text-gray-600 leading-8'>
                    <img
                        ...
                        src={`http://127.0.0.1:1337${article.attributes.image.data[0].attributes.url}`}
            ...
            <div className="sticky top-0">
                    ...
                    <input className="border w-full p-2 pl-3 my-6 outline-primary" type="email"  placeholder="Your work email" />
...
export const getServerSideProps: GetServerSideProps = async ({ query }) => {
    ...
    return {
        props: {
            article: await serializMarkDown(articles.data[0]),
        }
    }
}